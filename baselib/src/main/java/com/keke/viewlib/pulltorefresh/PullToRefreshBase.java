...
import com.keke.viewlib.pulltorefresh.internal.FlipLoadingLayout;
import com.keke.viewlib.pulltorefresh.internal.RotateLoadingLayout;
import com.keke.viewlib.pulltorefresh.internal.Utils;
import com.keke.viewlib.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected final void refreshLoadingViewsSize() {
		...
		if (DEBUG) {
			Log.d(LOG_TAG, String.format("Setting Padding. BaseLog: %d, T: %d, R: %d, B: %d", pLeft, pTop, pRight, pBottom));
		}
