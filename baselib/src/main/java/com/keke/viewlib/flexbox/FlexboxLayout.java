...
package com.keke.viewlib.flexbox;
...
public class FlexboxLayout extends ViewGroup implements FlexContainer {
    ...
    public FlexboxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFlexDirection = a.getInt(R.styleable.FlexboxLayout_flexDirection, FlexDirection.ROW);
        mFlexWrap = a.getInt(R.styleable.FlexboxLayout_flexWrap, FlexWrap.NOWRAP);
        mJustifyContent = a.getInt(R.styleable.FlexboxLayout_justifyContent, JustifyContent.FLEX_START);
