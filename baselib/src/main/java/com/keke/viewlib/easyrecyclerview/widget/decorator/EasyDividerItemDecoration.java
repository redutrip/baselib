...
package com.keke.viewlib.easyrecyclerview.widget.decorator;
...
public class EasyDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public EasyDividerItemDecoration(Activity activity) {
        this.setDivider(activity,R.drawable.decoration_line_y1);
        this.setOrientation(EasyDividerItemDecoration.VERTICAL_LIST);
        this.verticalpadding =  (int) activity.getResources().getDimension(R.dimen.y1);
    }
    ...
    public EasyDividerItemDecoration(Activity activity, int orientation, int drawableId,int verticalpadding) {
        this.setDivider(activity, drawableId);
        this.setOrientation(orientation);
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = parent.getPaddingLeft() + verticalpadding;
        final int right = parent.getWidth() - parent.getPaddingRight() - verticalpadding;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if(dividerSpace == 0){
            dividerSpace = this.mDivider.getIntrinsicHeight();
        }
        if (this.mOrientation == VERTICAL_LIST) {
            outRect.set(0, 0, 0,dividerSpace);
        } else {
            outRect.set(0, 0,dividerSpace, 0);
        }
    }
    ...
    public void setVtypePadding(int padding){
