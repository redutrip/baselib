...
public class AlertView {
    ...
    protected void initViews(){
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.iosalert_layout_alertview, decorView, false);
        ...
        switch (style){
            case ActionSheet:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.iosaleart_margin_actionsheet_left_right);
            ...
            case Alert:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.iosaleart_margin_alert_left_right);
    ...
    protected void initListView(){
        ...
        if(cancel != null && style == Style.Alert){
            View itemView = LayoutInflater.from(context).inflate(R.layout.iosalert_item_alertbutton, null);
            TextView tvAlert = (TextView) itemView.findViewById(R.id.tvAlert);
            tvAlert.setText(cancel);
            tvAlert.setClickable(true);
            tvAlert.setTextColor(context.getResources().getColor(R.color.iosalert_button_cancel));
            tvAlert.setBackgroundResource(R.drawable.iosalert_bg_alertbutton_bottom);
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.iosalert_layout_alertview_actionsheet,contentContainer);
    ...
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.iosalert_layout_alertview_alert, contentContainer);
        initHeaderView(viewGroup);
        ...
        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
            ...
            for (int i = 0; i < mDatas.size(); i ++) {
                ...
                if (i != 0){
                    ...
                    divier.setBackgroundColor(context.getResources().getColor(R.color.iosalert_divier));
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int)context.getResources().getDimension(R.dimen.iosaleart_size_divier), LinearLayout.LayoutParams.MATCH_PARENT);
                ...
                if(mDatas.size() == 1){
                    ...
                    tvAlert.setBackgroundResource(R.drawable.iosalert_bg_alertbutton_left);
                }
                else if(i == mDatas.size() - 1){//设置最右边的按钮效果
                    tvAlert.setBackgroundResource(R.drawable.iosalert_bg_alertbutton_right);
                }
                ...
                //高亮按钮的样式
                    ...
                    tvAlert.setTextColor(context.getResources().getColor(R.color.iosalert_button_destructive));
                }
    ...
    public void setMarginBottom(int marginBottom){
        ...
        int margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.iosaleart_margin_alert_left_right);
