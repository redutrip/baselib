package com.keke.viewlib.tablayout;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void setTabTitles(String[] mSegmentTLTitles) {
        ArrayList<CustomTabEntity> mTabEntities = new ArrayList<>();
        int[] mIconUnselectIds = {R.drawable.bg_null, R.drawable.bg_null, R.drawable.bg_null,R.drawable.bg_null};
        int[] mIconSelectIds = {R.drawable.bg_null, R.drawable.bg_null, R.drawable.bg_null,R.drawable.bg_null};
        ...
        this.mTabEntitys.addAll(mTabEntities);
