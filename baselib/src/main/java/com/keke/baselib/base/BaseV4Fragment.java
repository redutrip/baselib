...
//支持v4包Fragment
public  abstract class BaseV4Fragment extends Fragment implements BaseView{
    ...
    public void showLoadingBar() {
        ((BaseV4Activity)getActivity()).getProgressMaterial().show();
    }

    @Override
    public void hideLoadindBar() {
        ((BaseV4Activity)getActivity()).getProgressMaterial().hide();
    }
